...
public class CaptchaConfig {
    ...
    public DefaultKaptcha getKaptchaBeanMath() {
        ...
        // 验证码图片高度 默认为50
        properties.setProperty(KAPTCHA_IMAGE_HEIGHT, "60");
        // 验证码文本字符大小 默认为40，改为50以适配老年用户
        properties.setProperty(KAPTCHA_TEXTPRODUCER_FONT_SIZE, "50");
        // KAPTCHA_SESSION_KEY
        properties.setProperty(KAPTCHA_SESSION_CONFIG_KEY, "kaptchaCodeMath");
        // 验证码文本生成器
        properties.setProperty(KAPTCHA_TEXTPRODUCER_IMPL, "com.etsong.framework.config.KaptchaTextCreator");
        // 验证码文本字符间距 默认为2，改为5以提升可读性
        properties.setProperty(KAPTCHA_TEXTPRODUCER_CHAR_SPACE, "5");
        // 验证码文本字体样式，默认包含斜体，改为Arial
        properties.setProperty(KAPTCHA_TEXTPRODUCER_FONT_NAMES, "Arial");
