<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['questions:topic:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['questions:topic:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['questions:topic:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['questions:topic:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="topicList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="题目序号" align="center" prop="topicId" />
      <el-table-column label="题干" align="center" prop="topicContent" />
      <el-table-column label="题目类别" align="center" prop="prototypeId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="题目类别" prop="prototypeId">
          <el-input v-model="form.prototypeId" placeholder="请输入题目类别" />
        </el-form-item>
      </el-form>
...
<script>
import { listTopic, getTopic, delTopic, addTopic, updateTopic } from "@/api/questions/topic"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除题目管理编号为"' + topicIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('questions/topic/export', {
        ...this.queryParams
